...
isStateAcceptable state=
  (state.statisticalMetadataList == StateAcceptableStatisticalWebPageStatisticalMetadataList || state.statisticalMetadataList == StateStartStatisticalWebPageStatisticalMetadataList)
