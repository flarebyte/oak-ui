module Flarebyte.Oak.Domain.Attribute exposing (Attribute, AttributeState, AttributeAndState, reset, resetState, resetAndState)
...
resetAndState: AttributeAndState 
resetAndState = 
  {
   value= alpha
    ,state= beta
